...
Theorem rev_exercise1 : forall (l l' : list nat),
     ...
     l' = rev l.
Proof.
  intros. rewrite -> H. symmetry. rewrite -> rev_involutive. reflexivity. Qed.
(** [] *)
  ...
  - intros m eq.
   ...
   - intros m eq. destruct m.
    ...
    + simpl in eq. inversion eq. rewrite <- plus_n_Sm in H0.
      ...
      apply f_equal. apply IHn'. symmetry. apply H1. Qed.
...
Proof.
  ...
  - intros n eq. destruct n.
    + inversion eq.
    + inversion eq. apply IHl. reflexivity.
    Qed.
...
[]
 *)
(*Check fun n:nat nat=> pred(S n)=n.*) 
